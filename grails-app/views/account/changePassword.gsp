...
<title><g:message code="security.change.password.label" /> - <g:message code="default.application.title" /></title>
...
<body>
	<h1><g:message code="security.change.password.label" /> - <g:message code="default.application.title" /></h1>

	<g:form name="passwordForm" action="updatePassword" controller="account" autocomplete="off">
		...
		<legend>Change your password</legend> 
			...
			<div class='login_message'>${flash.message}</div>
				...
				<p>
					...
					<input type="password" name="passwordOld" id="passwordOld" class="text_" />
				</p>
				-->
				<p>
...
<!--
(function(){
	document.forms['passwordForm'].elements['oldPassword'].focus();
})();
// -->
</script>
</body>
